<!-- Seite: Benutzeranmeldung

Ermöglicht Nutzern, sich mit ihrer E-Mail-Adresse und Passwort anzumelden.
Das Formular sendet die Daten per POST an die Login-Route. -->
@extends('layout')
...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Sign in to your account" class="mx-auto h-10 w-auto" />
