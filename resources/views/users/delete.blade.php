<!-- Komponente: Benutzerkonto löschen (Modal)

Zeigt ein Bestätigungsdialogfeld zum Löschen des Benutzerkontos an.
Erwartete Variable:
$user: User -->

<button command="show-modal" commandfor="dialog" class="rounded-md bg-gray-950/5 px-2.5 py-1.5 text-sm font-semibold text-gray-900 hover:bg-gray-950/10">Delete account</button>
<el-dialog>
