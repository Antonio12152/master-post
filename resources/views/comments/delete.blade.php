<!-- Komponente: Kommentar löschen (Modal)

Zeigt ein Bestätigungsdialogfeld zum Löschen eines Kommentars an.
Erwartete Variable:
$comment: Comment -->

<button command="show-modal" commandfor="dialog" class="rounded-md bg-gray-950/5 px-2.5 py-1.5 text-sm font-semibold text-gray-900 hover:bg-gray-950/10">Delete comment</button>
<el-dialog>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 id="dialog-title" class="text-base font-semibold text-gray-900">Delete comment</h3>
                            <div class="mt-2">
