<!-- Komponente: Beitrag löschen (Modal)

Zeigt ein Bestätigungsdialogfeld zum Löschen eines Beitrags an.
Erwartete Variable:
$post: Post -->
<button command="show-modal" commandfor="dialog" class="rounded-md bg-gray-950/5 px-2.5 py-1.5 text-sm font-semibold text-gray-900 hover:bg-gray-950/10">Delete post</button>
<el-dialog>
